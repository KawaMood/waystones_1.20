#> pk_waystones:blocks/waystone/actions/craft/trigger/nether

# Remove advancement and recipe
advancement revoke @s only pk_waystones:interactions/crafted_nether_waystone
recipe take @s pk_waystones:nether_waystone
