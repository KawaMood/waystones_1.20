...
execute unless score $pk.waystones.settings.name_visibility pk.value matches 1 run tellraw @a [{"text": "Name Visibility","color": "light_purple"},{"text": " setting is already set on ","color": "red"},{"text": "Hide","color": "light_purple"}]
