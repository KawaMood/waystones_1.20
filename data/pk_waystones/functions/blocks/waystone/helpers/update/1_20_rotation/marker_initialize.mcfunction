#> pk_waystones:blocks/waystone/helpers/update/1_20_rotation/marker_initialize
...
execute if score $temp pk.dimension.id matches -1 in minecraft:the_nether positioned as @s run function pk_waystones:blocks/waystone/helpers/update/1_20_rotation/forceload_custom_block_chunk
execute if score $temp pk.dimension.id matches 0 in minecraft:overworld positioned as @s run function pk_waystones:blocks/waystone/helpers/update/1_20_rotation/forceload_custom_block_chunk
execute if score $temp pk.dimension.id matches 1 in minecraft:the_end positioned as @s run function pk_waystones:blocks/waystone/helpers/update/1_20_rotation/forceload_custom_block_chunk
execute if score $temp pk.dimension.id matches 100.. at @e[type=marker,tag=pk.dimension.marker,predicate=pk_waystones:scores/dimension_marker/matching_id] positioned as @s run function pk_waystones:blocks/waystone/helpers/update/1_20_rotation/forceload_custom_block_chunk