#> pk_waystones:blocks/waystone/helpers/update/1_20_rotation/start
...
# 1 second after
schedule function pk_waystones:blocks/waystone/helpers/update/1_20_rotation/after_1s 1s