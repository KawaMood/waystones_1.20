...
# - CB 2
setblock -30000000 65 1611 chain_command_block[conditional=false,facing=up]{auto:1b,UpdateLastExecution:0b,Command:"function pk_waystones:blocks/waystone/use/gui/waypoints/click/cb/2"} replace
# - CB 3
