...
execute if score $random pk.value matches ..250 run tp @s ~0.5 ~ ~-0.5 
execute if score $random pk.value matches 251..500 run tp @s ~0.5 ~ ~1.5
execute if score $random pk.value matches 501..750 run tp @s ~-0.5 ~ ~0.5
execute if score $random pk.value matches 751.. run tp @s ~1.5 ~ ~0.5
