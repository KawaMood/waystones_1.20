...
# Set data
data merge entity @s {item:{id:"minecraft:nether_brick_slab",Count:1b},transformation:{scale:[0.9375f,0.9375f,0.9375f],translation:[0.5f,1.235f,0.5f],right_rotation:[0f,1f,0f,0f]}}