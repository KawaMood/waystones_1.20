...
# Set data
data merge entity @s {item:{id:"minecraft:andesite",Count:1b},transformation:{scale:[0.6875f,0.6875f,0.6875f],translation:[0.5f,0.755f,0.5f],right_rotation:[0f,1f,0f,0f]}}