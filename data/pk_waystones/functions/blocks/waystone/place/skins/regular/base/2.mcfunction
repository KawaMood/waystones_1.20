...
# Set data
data merge entity @s {item:{id:"minecraft:polished_andesite_slab",Count:1b},transformation:{scale:[1f,1f,1f],translation:[0.5f,0.5f,0.5f],right_rotation:[0f,1f,0f,0f]}}