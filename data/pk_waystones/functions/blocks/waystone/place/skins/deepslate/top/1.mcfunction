...
# Set data
data merge entity @s {item:{id:"minecraft:deepslate_brick_slab",Count:1b},transformation:{scale:[0.9375f,0.9375f,0.9375f],translation:[0.5f,0.1770f,0.5f],right_rotation:[0f,1f,0f,0f]}}
