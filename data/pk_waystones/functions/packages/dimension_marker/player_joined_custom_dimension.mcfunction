...
execute store result score $already_forceloaded pk.temp run forceload query -3000 1611
execute if score $already_forceloaded pk.temp matches 0 run forceload add -3000 1611
execute positioned -3000 0 1611 unless entity @e[type=marker,tag=pk.dimension.marker,distance=..0.1] summon marker run function pk_waystones:packages/dimension_marker/marker_initialize
