#> pk_waystones:base/uninstall/cbs_prepare_recursive
...
data modify block -30000000 62 1611 front_text.messages[0] set value '[{"text":"execute in "},{"nbt":"Uninstall.Chunk.Dimension","storage":"pk.common:data"},{"text":" positioned "},{"nbt":"Uninstall.Chunk.x","storage":"pk.common:data"},{"text":" 0 "},{"nbt":"Uninstall.Chunk.z","storage":"pk.common:data"},{"text":" run function pk_waystones:base/uninstall/cb_3"}]'
...
# - CB 2
setblock -30000000 65 1611 chain_command_block[conditional=false,facing=up]{auto:1b,UpdateLastExecution:0b,Command:"function pk_waystones:base/uninstall/cb_2"} replace
# - CB 3
...
execute if data storage pk.common:data Uninstall.Chunks[{}] run schedule function pk_waystones:base/uninstall/cbs_prepare_recursive 2t